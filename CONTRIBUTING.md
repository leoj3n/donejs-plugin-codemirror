# Contributing to donejs-plugin-codemirror

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/leoj3n/donejs-plugin-codemirror) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-plugin-codemirror, you can start by going to its [fork page](https://github.com/leoj3n/donejs-plugin-codemirror/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-plugin-codemirror
```
